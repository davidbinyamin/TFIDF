...
namespace TFIDF_Tests
{
    ...
    public class TextUtilTests
    {
        ...
        public void NoContentShoulBeStriped()
        {
            ...
            Assert.AreEqual(4, tokenizedText.Length, "Icorrect number of tokens");
        ...
        public void ShouldStripNumbers()
        {
            ...
            Assert.AreEqual(15, tokenizedText.Length, "Icorrect number of tokens");
    ...
    public class TfTests
    {
        ...
        public static void Init(TestContext tc)
        {
            ...
            File.WriteAllText(m_path + m_testFile, m_text);
        }
